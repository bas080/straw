...
let tests =
  ...
  [
    ...
    "Path.{to,from}_string", [ test_case "String to and from" `Quick test_to_from_string ];
    "Path.quoted", [ test_case "Converts a string to its quoted form" `Quick test_to_quoted ];
    "Path.append", [
    ...
    "Path.parts", [ test_case "Splits a path into its parts" `Quick test_parts ];
    "Path.to_relative", [ test_case "Converts to a relative path given a root" `Quick test_to_relative ];
    "Path.to_absolute", [ test_case "Converts a relative path to absolute" `Quick test_to_absolute ];
    "Path.extension", [
